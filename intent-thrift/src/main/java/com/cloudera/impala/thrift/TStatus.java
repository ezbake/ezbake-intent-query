            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.error_msgs = new ArrayList<String>(_list72.size);
                for (int _i73 = 0; _i73 < _list72.size; ++_i73)
                {
                  String _elem74;
                  _elem74 = iprot.readString();
                  struct.error_msgs.add(_elem74);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TStatus struct) throws org.apache.thrift.TException {
      ...
      if (struct.error_msgs != null) {
        oprot.writeFieldBegin(ERROR_MSGS_FIELD_DESC);
        {
          ...
          for (String _iter75 : struct.error_msgs)
          {
      ...
      if (struct.isSetError_msgs()) {
        {
          ...
          for (String _iter76 : struct.error_msgs)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.error_msgs = new ArrayList<String>(_list77.size);
          for (int _i78 = 0; _i78 < _list77.size; ++_i78)
          {
            String _elem79;
            _elem79 = iprot.readString();
            struct.error_msgs.add(_elem79);
          }
        }
        struct.setError_msgsIsSet(true);
      }
