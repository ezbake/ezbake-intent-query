            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.accepted_conjuncts = new ArrayList<Integer>(_list48.size);
                for (int _i49 = 0; _i49 < _list48.size; ++_i49)
                {
                  int _elem50;
                  _elem50 = iprot.readI32();
                  struct.accepted_conjuncts.add(_elem50);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPrepareResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.accepted_conjuncts != null) {
        oprot.writeFieldBegin(ACCEPTED_CONJUNCTS_FIELD_DESC);
        {
          ...
          for (int _iter51 : struct.accepted_conjuncts)
          {
      ...
      if (struct.isSetAccepted_conjuncts()) {
        {
          ...
          for (int _iter52 : struct.accepted_conjuncts)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.accepted_conjuncts = new ArrayList<Integer>(_list53.size);
          for (int _i54 = 0; _i54 < _list53.size; ++_i54)
          {
            int _elem55;
            _elem55 = iprot.readI32();
            struct.accepted_conjuncts.add(_elem55);
          }
        }
        struct.setAccepted_conjunctsIsSet(true);
      }
