...
public class BinaryPredicate implements org.apache.thrift.TBase<BinaryPredicate, BinaryPredicate._Fields>, java.io.Serializable, Cloneable, Comparable<BinaryPredicate> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("BinaryPredicate");
  ...
  static {
    schemes.put(StandardScheme.class, new BinaryPredicateStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BinaryPredicateTupleSchemeFactory());
  }
   ...
   * @see BinaryOperator
   */
  public BinaryOperator operator; // required
  public ColumnValue value; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.OPERATOR, new org.apache.thrift.meta_data.FieldMetaData("operator", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, BinaryOperator.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(BinaryPredicate.class, metaDataMap);
  }
   ...
   */
  public BinaryPredicate(BinaryPredicate other) {
  ...
  public BinaryPredicate deepCopy() {
  ...
  public BinaryPredicate setColumnName(String columnName) {
    this.columnName = columnName;
    return this;
  }
   ...
   * @see BinaryOperator
   */
  public BinaryPredicate setOperator(BinaryOperator operator) {
    this.operator = operator;
    return this;
  }
  ...
  public BinaryPredicate setValue(ColumnValue value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof BinaryPredicate)
      return this.equals((BinaryPredicate)that);
    return false;
  }

  public boolean equals(BinaryPredicate that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(BinaryPredicate other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("BinaryPredicate(");
    boolean first = true;
  ...
  private static class BinaryPredicateStandardSchemeFactory implements SchemeFactory {
    public BinaryPredicateStandardScheme getScheme() {
      return new BinaryPredicateStandardScheme();
    }
  }

  private static class BinaryPredicateStandardScheme extends StandardScheme<BinaryPredicate> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, BinaryPredicate struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 2: // OPERATOR
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.operator = BinaryOperator.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BinaryPredicate struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class BinaryPredicateTupleSchemeFactory implements SchemeFactory {
    public BinaryPredicateTupleScheme getScheme() {
      return new BinaryPredicateTupleScheme();
    }
  }

  private static class BinaryPredicateTupleScheme extends TupleScheme<BinaryPredicate> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, BinaryPredicate struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, BinaryPredicate struct) throws org.apache.thrift.TException {
