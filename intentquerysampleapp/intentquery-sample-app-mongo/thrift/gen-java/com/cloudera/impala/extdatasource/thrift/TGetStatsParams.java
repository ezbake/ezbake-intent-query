...
public class TGetStatsParams implements org.apache.thrift.TBase<TGetStatsParams, TGetStatsParams._Fields>, java.io.Serializable, Cloneable, Comparable<TGetStatsParams> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TGetStatsParams");
  ...
  static {
    schemes.put(StandardScheme.class, new TGetStatsParamsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TGetStatsParamsTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.INIT_STRING};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TGetStatsParams.class, metaDataMap);
  }

  public TGetStatsParams() {
  }
   ...
   */
  public TGetStatsParams(TGetStatsParams other) {
  ...
  public TGetStatsParams deepCopy() {
    return new TGetStatsParams(this);
  }
  ...
  public TGetStatsParams setTable_name(String table_name) {
    this.table_name = table_name;
    return this;
  }
  ...
  public TGetStatsParams setInit_string(String init_string) {
  ...
  public TGetStatsParams setPredicates(List<List<TBinaryPredicate>> predicates) {
    this.predicates = predicates;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TGetStatsParams)
      return this.equals((TGetStatsParams)that);
    return false;
  }

  public boolean equals(TGetStatsParams that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TGetStatsParams other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TGetStatsParams(");
    boolean first = true;
  ...
  private static class TGetStatsParamsStandardSchemeFactory implements SchemeFactory {
    public TGetStatsParamsStandardScheme getScheme() {
      return new TGetStatsParamsStandardScheme();
    }
  }

  private static class TGetStatsParamsStandardScheme extends StandardScheme<TGetStatsParams> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TGetStatsParams struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.predicates = new ArrayList<List<TBinaryPredicate>>(_list24.size);
                for (int _i25 = 0; _i25 < _list24.size; ++_i25)
                {
                  List<TBinaryPredicate> _elem26;
                  {
                    org.apache.thrift.protocol.TList _list27 = iprot.readListBegin();
                    _elem26 = new ArrayList<TBinaryPredicate>(_list27.size);
                    for (int _i28 = 0; _i28 < _list27.size; ++_i28)
                    {
                      TBinaryPredicate _elem29;
                      _elem29 = new TBinaryPredicate();
                      _elem29.read(iprot);
                      _elem26.add(_elem29);
                    }
                    iprot.readListEnd();
                  }
                  struct.predicates.add(_elem26);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TGetStatsParams struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TGetStatsParamsTupleSchemeFactory implements SchemeFactory {
    public TGetStatsParamsTupleScheme getScheme() {
      return new TGetStatsParamsTupleScheme();
    }
  }

  private static class TGetStatsParamsTupleScheme extends TupleScheme<TGetStatsParams> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TGetStatsParams struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      oprot.writeString(struct.table_name);
      {
        oprot.writeI32(struct.predicates.size());
        for (List<TBinaryPredicate> _iter32 : struct.predicates)
        {
          {
            oprot.writeI32(_iter32.size());
            for (TBinaryPredicate _iter33 : _iter32)
            {
              _iter33.write(oprot);
            }
          }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TGetStatsParams struct) throws org.apache.thrift.TException {
      ...
      struct.setTable_nameIsSet(true);
      {
        ...
        struct.predicates = new ArrayList<List<TBinaryPredicate>>(_list34.size);
        for (int _i35 = 0; _i35 < _list34.size; ++_i35)
        {
          List<TBinaryPredicate> _elem36;
          {
            org.apache.thrift.protocol.TList _list37 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
            _elem36 = new ArrayList<TBinaryPredicate>(_list37.size);
            for (int _i38 = 0; _i38 < _list37.size; ++_i38)
            {
              TBinaryPredicate _elem39;
              _elem39 = new TBinaryPredicate();
              _elem39.read(iprot);
              _elem36.add(_elem39);
            }
          }
          struct.predicates.add(_elem36);
        }
      }
      struct.setPredicatesIsSet(true);
