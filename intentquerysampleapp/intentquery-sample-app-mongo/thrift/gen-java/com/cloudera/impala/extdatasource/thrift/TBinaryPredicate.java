...
public class TBinaryPredicate implements org.apache.thrift.TBase<TBinaryPredicate, TBinaryPredicate._Fields>, java.io.Serializable, Cloneable, Comparable<TBinaryPredicate> {
  ...
  public TColumnDesc col; // required
  /**
   * 
   * @see TComparisonOp
   */
  public TComparisonOp op; // required
  public com.cloudera.impala.thrift.TColumnValue value; // required
  ...
  public TBinaryPredicate(
    TColumnDesc col,
    TComparisonOp op,
    com.cloudera.impala.thrift.TColumnValue value)
  {
    this();
    this.col = col;
    this.op = op;
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (col == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'col' was not present! Struct: " + toString());
    }
    if (op == null) {
